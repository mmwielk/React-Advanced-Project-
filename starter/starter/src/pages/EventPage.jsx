...
export const EventPage = () => {
  ...
  const fetchEvent = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/events/${id}`); // Modified URL
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(`http://localhost:3000/events/${id}`, updatedEvent); // Modified URL
      toast({
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`http://localhost:3000/events/${id}`); // Modified URL
      toast({
